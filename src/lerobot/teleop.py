...
EPISODE_TIME_SEC = 45
RESET_TIME_SEC = 15
TASK_DESCRIPTION = "Recording test"
HF_USERNAME = "AS-24"
DATASET_NAME = "so100-teleop-demo"
...
robot_config = SO100FollowerConfig(
    ...
    cameras={
        ...
        "top": OpenCVCameraConfig(index_or_path=1, width=640, height=480, fps=FPS) # Optional: fourcc="MJPG" for troubleshooting OpenCV async error.
    },
    port="COM4",
)
